...
function About(p_open::Ref{Bool})
  ...
  CImGui.Separator()
  CImGui.Text("Magnetic and Electric Field 2D app allow to calculate magnetic and electric field in two dimensional arrangement of three phase power lines or underground cables.")
